...
def genetic_algorithm(person1, person2, safety_distance, process_duration, population_size=10000, generations=10000):
...
person2 = [int(x) for x in '121212'][0:3] + [int(x) for x in '121212'][3:6]  # Bsp. S.39
